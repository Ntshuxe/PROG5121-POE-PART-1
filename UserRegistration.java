...
public class UserRegistration{
 ...
 private static String userName;
    ...
    public static void main(String[] args) {
        ...
        // If registration is successfull allow login if not the loop will prompt the user to retry until successful
        while (regStatus.equals("Registration successful.")) {
